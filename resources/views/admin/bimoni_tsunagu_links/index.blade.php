...
<div class="bg-white border border-gray-200 rounded-lg p-6 mb-6">
    <p class="text-xs text-gray-500 mb-3">
        「日付 - TSUNAGU - 名前 - フリガナ - 商品名 - 金額」の順にタブ区切りで貼り付けてください。1行1件です。日付・商品名は参考表示のみで、着金日は登録した日になります。金額は¥1,000または¥500のみ対応（¥1,000→TSUNAGU単価1,000円/パートナー単価800円、¥500→TSUNAGU単価500円/パートナー単価400円）。名前・フリガナで、案件「BIMONI【募集モニター30件以上】」の問い合わせのみを検索します。
    </p>
