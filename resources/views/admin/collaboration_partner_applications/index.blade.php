...
<div class="flex border-b border-gray-200 mb-4">
    @foreach ($statusTabs as $key => $tab)
        ...
        <a href="{{ route('admin.collaboration-partner-applications.index', $key === 'all' ? [] : ['status' => $key]) }}"
    ...
    <table class="w-full text-sm">
        <thead class="bg-gray-50 text-gray-500 text-left">
            <tr>
                ...
                <th class="px-4 py-3 font-medium">申請元パートナー</th>
                <th class="px-4 py-3 font-medium">共創したい内容</th>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <div class="flex gap-1 justify-center flex-wrap">
                            <a href="{{ route('admin.collaboration-partner-applications.show', $application) }}" class="text-xs bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded">詳細</a>
                        </div>
                    </td>
                    <td class="px-4 py-3">
