        ...
        <header class="bg-white border-b border-gray-200">
            <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <nav class="hidden sm:flex items-center gap-4 text-sm">
                    ...
                    <a href="{{ route('agency.line-notification-settings.edit') }}" class="hover:text-blue-600 {{ request()->routeIs('agency.line-notification-settings.*') ? 'font-semibold text-blue-600' : 'text-gray-600' }}">LINE通知設定</a>
            ...
            <nav id="agency-nav-mobile" class="hidden sm:hidden border-t border-gray-100 px-4 py-2 flex flex-col gap-1 text-sm">
                ...
                <a href="{{ route('agency.line-notification-settings.edit') }}" class="py-2 {{ request()->routeIs('agency.line-notification-settings.*') ? 'font-semibold text-blue-600' : 'text-gray-600' }}">LINE通知設定</a>
