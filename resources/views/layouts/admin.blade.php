    ...
    @php
        ...
        $navGroups = [
            ...
            'MK振り分け管理' => [
                ...
                'bimoni_tsunagu_links' => ['label' => 'BIMONI(TSUNAGU)', 'route' => 'admin.bimoni-tsunagu-links.index', 'active' => 'admin.bimoni-tsunagu-links.*'],
                ...
                'sharepoy_points' => ['label' => 'SharePoyポイント用', 'route' => 'admin.sharepoy-points.index', 'active' => 'admin.sharepoy-points.*'],
                'sharepoy_deposit_history' => ['label' => 'SharePoy着金履歴管理', 'route' => 'admin.sharepoy-deposit-history.index', 'active' => 'admin.sharepoy-deposit-history.*'],
            ],
        ];
    @endphp
