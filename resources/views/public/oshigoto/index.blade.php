...
@push('styles')
<style>
.og-wrap{max-width:760px;margin:0 auto;padding:1rem 1.25rem 4rem;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Hiragino Sans",Meiryo,sans-serif;color:#111827}
.og-wrap *{box-sizing:border-box}
.og-header{text-align:center;margin-bottom:16px}
.og-logo{display:block;max-width:100%;width:100%;height:auto;margin:0 auto 6px;border-radius:16px}
