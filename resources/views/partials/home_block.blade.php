...
@elseif ($block->type === 'sales_materials')
    ...
    @forelse ($salesMaterials as $material)
        <div class="material-item">
            ...
            <a href="{{ \Illuminate\Support\Facades\Storage::url($material->file_path) }}" download="{{ $material->original_filename ?: $material->title.'.pdf' }}" target="_blank" rel="noopener" class="dl-btn">
